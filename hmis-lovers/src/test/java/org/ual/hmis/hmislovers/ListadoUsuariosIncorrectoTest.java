...
import java.net.URL;
public class ListadoUsuariosIncorrectoTest {
  ...
  public void listadoUsuariosIncorrecto() {
    ...
    // Step # | name | target | value
	  driver.get("https://calm-moss-09572aa03.7.azurestaticapps.net/");
	    ...
	    btnAdmin.click();
    // 4 | click | css=.admin-search-input | 
    driver.findElement(By.cssSelector(".admin-search-input")).click();
    // 5 | type | css=.admin-search-input | aifoaid
    driver.findElement(By.cssSelector(".admin-search-input")).sendKeys("aifoaid");
    // 6 | click | css=.empty-table-message > p | 
    driver.findElement(By.cssSelector(".empty-table-message > p")).click();
    // 7 | assertText | css=.empty-table-message > p | No se encontraron usuarios que coincidan con la búsqueda.
    assertThat(driver.findElement(By.cssSelector(".empty-table-message > p")).getText(), is("No se encontraron usuarios que coincidan con la búsqueda."));
  }
}
